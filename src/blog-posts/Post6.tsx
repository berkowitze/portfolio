        ...
        <p>
          ...
          <OrderedList>
            ...
            <li>
              ...
              light is determined by the global position of that point. With
              some scaling constant, if the coordinate is even, it is colored
              one way, and if it's odd, another way.
              <Image
            ...
            <li>
              ...
              <a href="https://en.wikipedia.org/wiki/UV_mapping">
                UV coordinate
              </a>{" "}
              of the hit surface. For a sphere (the only shape I have right
              now), the UV coordinate can be calculated as the latitude and
              longitude, normalized from 0 to 1.
              <br />
              The 2D UV coordinate can then be used to look up the pixel value
              in a loaded image. I use the{" "}
            ...
            <li>
              ...
              wouldn't tile that well and is less fun than writing a perlin
              noise generator from scratch! I won't go into too many details
              (see{" "}
            ...
            <li>
              ...
              infinitely thin), but otherwise quads were pretty easy to
              implement.
              <Image
            ...
            <li>
              ...
              gains "energy" (it either stays the same brightness or gets
              dimmer). Emissive materials allow a surface to add light to a ray,
              making it appear like that surface is glowing.
              <Image
            ...
            <li>
              Translation and rotation transformations. Rather than having to
              move or rotate every single vertex in a mesh to put it in a new
              location in space (which could cause distortions, require normals
              to be recomputed, etc), it is far more efficient to transform the
              rays in the opposite direction so that they are in the object's
              transformed coordinate space. Then the same ray-object
              intersection test as before can be used.
              <br />
            ...
            <li>
              Throughout this week, I spent a while making two large
              improvements to my raytracer that aren't covered in the Ray
              Tracing books.
              <br />
              ...
              that renders chunks of the final image, then combines them all
              into a single image once each chunk is complete. Depending on
              hardware, this can lead to a large speedup (for me it tends to be
              a 4-8x speedup).
              <br />
              ...
              incomplete sections. The preview live-updates, making it easy to
              see the progress of a render and abort it if it's not going in the
              right direction.
              <Image
            ...
            <li>
              ...
              object. With a volumetric, rays of light pass some distance
              through the object before scattering in a random direction.
              <Image
