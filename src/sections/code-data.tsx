...
export const CODE_PROJECTS: Record<string, CodeProjectInfo> = {
  ...
  downup: {
    ...
    contributions: [
      "Built site from scratch",
      "UI/UX for creating and participating in fitness challenges",
      "Gamified UI to increase motivation and consistency",
    ],
  ...
  "analysis-tool": {
    ...
    contributions: [
      "Tool for customers to easily create datasets",
      "Tool for customers to run sequences of transformations and analyses on their datasets",
      "Worked with product and design to build the product from the ground up",
    ],
  ...
  exosim: {
    ...
    contributions: [
      "Exo-planet system physics simulation",
      "Interactive planetary system builder",
      "Real-time light curve visualization of planets passing in front of stars",
    ],
  ...
  life: {
    ...
    contributions: [
      "Life expectancy live-updates based on birth year, location, and sex",
